...
void
sample_decode_s8 (sample_t *dest, int8_t *src, size_t num_samples)
{
	debug_assert(dest != NULL);
	debug_assert(src != NULL);
	size_t i;
...
void
sample_encode_s8 (int8_t *dest, sample_t *src, size_t num_samples)
{
	debug_assert(dest != NULL);
	debug_assert(src != NULL);
	size_t i;
...
void
sample_convert_s8_to_u8 (uint8_t *dest, int8_t *src, size_t num_samples)
{
	debug_assert(dest != NULL);
	debug_assert(src != NULL);
	size_t i;
...
void
sample_convert_u8_to_s8 (int8_t *dest, uint8_t *src, size_t num_samples)
{
	debug_assert(dest != NULL);
	debug_assert(src != NULL);
	size_t i;
